...
{
    public partial class PurchaseOrderItemV2Ctrl : System.Web.UI.UserControl
    {
        ...
        public PurchaseOrderItemV2ViewModel PurchaseOrder
        {
            get;
            set;
        }
        ...
        public void InitializeFields(PurchaseOrderItemV2ViewModel objPurchaseOrder)
        {
            if (objPurchaseOrder != null)
            {
                //Set the fields
                hfPurchaseOrderId.Value = objPurchaseOrder.PurchaseOrdersV2Id.ToString();
                hfFiscalYearId.Value = objPurchaseOrder.FiscalYearId.ToString();

                litOffice.Text = objPurchaseOrder.OfficeName;
                litAccountingDate.Text = UIHelper.GetDateTimeInDefaultFormat(objPurchaseOrder.AccountingDate);
                litVendorName.Text = objPurchaseOrder.VendorName;
                litPONumber.Text = objPurchaseOrder.PONumber;
                litPOLineNumber.Text = objPurchaseOrder.POLineNumber.ToString();
                litPOLineDescription.Text = objPurchaseOrder.POLineItemDescription;
                litExpendedAmount.Text = UIHelper.GetAmountInDefaultFormat(objPurchaseOrder.ExpendedAmount);
                litPOBalance.Text= UIHelper.GetAmountInDefaultFormat(objPurchaseOrder.POBalance);
                txtDescription.Text = objPurchaseOrder.PODescription;
                ...
                chkTrainingExpense.Checked = objPurchaseOrder.IsTrainingExpense.Value;
            }
            else
            {
        ...
        protected void lnkSubmit_ServerClick(object sender, EventArgs e)
        {
            ...
            if (Mode == PurchaseOrderItemCtrlMode.Edit)
            {
                ...
                //var objPurchaseOrder = PurchaseOrderItemV2ViewModel.GetByPurchaseOrderID(lPurchaseOrderId);              
                ...
                PurchaseOrderItemV2ViewModel.Update(lPurchaseOrderId, long.Parse(ddlExpenditureSubCategory.SelectedValue), Convert.ToInt64(ddlAlternateOffice.Text), chkTrainingExpense.Checked,txtDescription.Text);
