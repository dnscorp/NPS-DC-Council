...
{
    public partial class    PurchaseOrdersV2Ctrl : System.Web.UI.UserControl
    {
        ...
        protected void rptrResult_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Literal litPOLineDescription = e.Item.FindControl("litPOLineDescription") as Literal;
                ...
                litPOLineDescription.Text = objSummary.POLineItemDescription;
                ...
                lnkEdit.Attributes.Add("PurchaseOrderId", objSummary.PurchaseOrdersV2Id.ToString());
                lnkDelete.Attributes.Add("PurchaseOrderId", objSummary.PurchaseOrdersV2Id.ToString());
            }
        }
        #endregion
        ...
        protected void PopupCtrl1_OkayButtonClick(object sender, EventArgs e)
        {
            ...
            {
                PurchaseOrderItemV2ViewModel.Delete(lPurchaseOrderId);
                //var objPurchaseOrder = PRIFACT.DCCouncil.NPS.Core.NPSDataHelper.PurchaseOrder.GetByPurchaseID(lPurchaseOrderId);
        ...
        private void _ShowItemPopup(PurchaseOrderItemCtrlMode purchaseOrderItemCtrlMode, PurchaseOrderItemV2ViewModel objPurchaseOrder)
        {
