<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VendorManagementCtrl.ascx.cs" Inherits="PRIFACT.DCCouncil.NPS.Web.Portal.UserCtrls.SiteAdministration.VendorManagementCtrl" %>
    ...
    <div class="popup-trigger">
        ...
        <asp:UpdatePanel ID="upSearchResults" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                ...
                <asp:Repeater ID="rptrResult" runat="server" OnItemDataBound="rptrResult_ItemDataBound" OnItemCommand="rptrResult_ItemCommand">
                    <HeaderTemplate>
                        <table cellspacing="0" cellpadding="0" class="grid">
                            <tr>
                                <th>
                                    <asp:LinkButton ID="lBtnOfficeName" runat="server" CommandName="Office" Text="Office"></asp:LinkButton>
                                </th>
                                <th>
                                    <asp:LinkButton ID="lBtnName" runat="server" CommandName="Name" Text="Name"></asp:LinkButton>
                                </th>
                                <th>
                                    <asp:LinkButton ID="lBtnIsRollup" runat="server" CommandName="IsRolledUp" Text="Is Rolled up?"></asp:LinkButton>
                                </th>
                                <%-- <th>
                                    <asp:LinkButton ID="lBtnIsDefault" runat="server" CommandName="IsDefault" Text="Is Default"></asp:LinkButton>
                                </th>--%>
                                <th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkIsRolledUp" runat="server" OnCheckedChanged="chkIsRolledUp_CheckedChanged" AutoPostBack="true"></asp:CheckBox>
                            </td>
                            <td>
                ...
                <uc2:PagerCtrl ID="PagerCtrl1" runat="server" PageSize="1000" OnBindMainRepeater="PagerCtrl1_BindMainRepeater" />
