...
{
    public class NPSReportTransactionSheetHelper
    {
        public static void GenerateTransactionSheet(ExcelGenerator objExcelGenerator, Office objOffice, FiscalYear objFiscalYear, DateTime dtAsOfDate, List<Expenditure> lstExpenditures, List<PurchaseOrder> lstPurchaseOrders)
        {
