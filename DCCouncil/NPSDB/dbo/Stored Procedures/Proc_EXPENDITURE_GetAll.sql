...
CREATE PROCEDURE Proc_EXPENDITURE_GetAll   
(      
    ...
    BEGIN      
      ...
      [O].[CreatedDate] AS OfficeCreatedDate,      
        ...
        [VendorName],      
            ...
            [ExpenditureCategoryIsMonthly],      
            [ExpenditureCategoryIsVendorStaff],      
            [ExpenditureCategoryIsSystemDefined],      
            [ExpenditureCategoryAppendMonth],      
            [ExpenditureCategoryIsVendorStaffAndOther],      
            [ExpenditureID],      
            [IsDeleted],      
            [OBJCode],      
            [UpdatedDate]      
    ...
    BEGIN      
     SELECT                 
      [E].[Amount],      
        ...
        ([E].[VendorName] LIKE '%'+@SearchText+'%' OR [E].[VendorName] LIKE '%'+@SearchText+'%' OR [E].[Description] LIKE '%'+@SearchText+'%' OR [E].[OBJCode] LIKE '%'+@SearchText+'%' OR [E].[Comments] LIKE '%'+@SearchText+'%'      
        OR [O].[IndexCode] LIKE '%' + @SearchText +'%' OR [O].[PCA] LIKE '%' +@SearchText +'%'))      
        AND [E].[IsDeleted] = 0   ORDER BY [E]. [DateOfTransaction]   
    END       
END
